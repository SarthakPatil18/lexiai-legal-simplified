      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            <div className="text-xs font-medium text-muted-foreground mb-5 uppercase tracking-[0.15em]">Why LexiAI</div>
            <h2 className="text-4xl md:text-6xl mb-5 leading-[0.95] text-balance tracking-[-0.04em] font-bold">
              Built on the standards of leading chambers.
            </h2>
          ...
          <div className="lg:col-span-7 space-y-3">
            {items.map((it, i) => (
              ...
              >
                <div className="size-12 shrink-0 rounded-2xl bg-secondary flex items-center justify-center group-hover:bg-foreground transition-all duration-500">
                  <it.icon className="size-5 text-foreground group-hover:text-background transition-colors" strokeWidth={1.75} />
                </div>
                <div className="flex-1">
                  <h3 className="text-base font-semibold mb-0.5 tracking-[-0.015em]">{it.title}</h3>
